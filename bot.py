...
async def start_command(client, message):
    ...
    caption = (
        f"[朱](t.me/zyndx) 𝙒𝙚𝙡𝙘𝙤𝙢𝙚\n\n"
        f"[㊄](t.me/zyndx)We present our new improved version, with fast and secure checks with different payment gateways and perfect tools for your use.\n\n"
        f"[╰┈➤](t.me/zyndx) 𝙑𝙚𝙧𝙨𝙞𝙤𝙣  -» 1.0"
    )
...
async def button_callback(client, callback_query):
    ...
    original_message = (
        f"<a href='https://t.me/zyndx'>朱</a> 𝙒𝙚𝙡𝙘𝙤𝙢𝙚\n\n"
        f"<a href='https://t.me/zyndx'>㊄</a> We present our new improved version, with fast and secure checks with different payment gateways and perfect tools for your use.\n\n"
        f"<a href='https://t.me/zyndx'>╰┈➤</a> 𝙑𝙚𝙧𝙨𝙞𝙤𝙣  -» 1.0"
    )
    ...
    if query.data == "gates":
        ...
        message_lines = [
            "#zyndx                                                                                𝙒𝙚𝙡𝙘𝙤𝙢𝙚 -» >_\n\n"
            f"║<a href='https://t.me/zyndx'>㊕</a>║ 𝙏𝙤𝙩𝙖𝙡 -» {len(LOADED_PLUGINS)}\n"
            f"║<a href='https://t.me/zyndx'>㊡</a>║ 𝙊𝙣 -» {len([p for p in LOADED_PLUGINS.values() if p.PLUGIN_INFO.get('status') == 'active'])} ✅\n"
            f"║<a href='https://t.me/zyndx'>㊤</a>║ 𝙊𝙛𝙛 -» {len([p for p in LOADED_PLUGINS.values() if p.PLUGIN_INFO.get('status') != 'active'])} ❌\n\n"
            "〈<a href='https://t.me/zyndx'>ゼ</a>〉𝙎𝙚𝙡𝙚𝙘𝙩 𝙩𝙝𝙚 𝙩𝙮𝙥𝙚 𝙤𝙛 𝙜𝙖𝙩𝙚 𝙮𝙤𝙪 𝙬𝙖𝙣𝙩 𝙛𝙤𝙧 𝙮𝙤𝙪𝙧 𝙪𝙨𝙚!"
        ]
        keyboard = [
        ...
        for name, module in LOADED_PLUGINS.items():
            ...
            if info.get('type') in ['auth', 'check']:
                ...
                auth_gates.append(f"〈<a href='https://t.me/zyndx'>朱</a>〉 {desc} -» {prefix}{cmd} -» {status}")
        
        message = "〈<a href='https://t.me/zyndx'>朱</a>〉𝙂𝙖𝙩𝙚𝙬𝙖𝙮𝙨 𝘼𝙪𝙩𝙝\n\n" + "\n".join(auth_gates) + "\n\n"
        ...
        for name, module in LOADED_PLUGINS.items():
            ...
            if info.get('type') == 'charge':
                ...
                desc = info.get('description', 'No description')
                status = "On ✅" if info.get('status') == 'active' else "Off ❌"
                charge_gates.append(f"〈<a href='https://t.me/zyndx'>朱</a>〉 {desc} -» {prefix}{cmd} -» {status}")
        
        message = "〈<a href='https://t.me/zyndx'>朱</a>〉𝙂𝙖𝙩𝙚𝙬𝙖𝙮𝙨 𝘾𝙝𝙖𝙧𝙜𝙚𝙙\n\n" + "\n".join(charge_gates) + "\n\n"
        keyboard = [[InlineKeyboardButton("Back", callback_data="gates")]]
        await query.edit_message_caption(
            caption=message,
            parse_mode=ParseMode.HTML,
        ...
        message = (
            "〈<a href='https://t.me/zyndx'>朱</a>〉𝙂𝙖𝙩𝙚𝙬𝙖𝙮𝙨 𝙏𝙤𝙤𝙡𝙨 🛠\n\n"
            "<a href='https://t.me/zyndx'>朱</a> 𝘽𝙞𝙣 -» info bin\n"
            "<a href='https://t.me/zyndx'>零</a> 𝘾𝙢𝙙 -» .bin -» Free\n"
            "<a href='https://t.me/zyndx'>ᥫ᭡</a> 𝙎𝙩𝙖𝙩𝙪𝙨 -» On ✅\n\n"
        )
